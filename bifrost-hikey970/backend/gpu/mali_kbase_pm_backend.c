...
void kbase_pm_register_access_enable(struct kbase_device *kbdev)
{
	...
	sj_dbg_all("SJ: in kbase_pm_register_access_enable\n");
...
void kbase_pm_register_access_disable(struct kbase_device *kbdev)
{
	...
	sj_dbg_all("SJ: in kbase_pm_register_access_disable\n");
...
void kbase_pm_do_poweron(struct kbase_device *kbdev, bool is_resume)
{
	...
	sj_dbg_all("SJ: pass kbase_pm_clock_on \n");
	...
	sj_dbg_all("SJ: pass kbase_pm_update_cores_state \n");
...
void kbase_pm_do_poweroff(struct kbase_device *kbdev, bool is_suspend)
{
	...
	sj_dbg_all("SJ DEBUG: in kbase_pm_do_poweroff!!!\n");
