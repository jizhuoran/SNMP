...
int kbase_platform_register(void)
{
	...
	printk("SJ: Pass this line 2 !!\n");


	mali_device = platform_device_alloc("mali", 0);
	
	printk("SJ: Pass this line 3 !!\n");

	if (mali_device == NULL)
		return -ENOMEM;

	printk("SJ: Pass this line 4 !!\n");
	...
	printk("SJ: Pass this line 6 !!\n");


	err = platform_device_add(mali_device);

	printk("SJ: Pass this line 7 !!\n");


	if (err) {
		platform_device_unregister(mali_device);

		printk("SJ: Pass this line 8 !!\n");
