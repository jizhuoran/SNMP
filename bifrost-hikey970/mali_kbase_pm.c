...
int kbase_pm_context_active_handle_suspend(struct kbase_device *kbdev, enum kbase_pm_suspend_handler suspend_handler)
{
	...
	sj_dbg_all("SJ: in kbase_pm_context_active_handle_suspend \n");
	...
	if (old_count == 0) {
		...
		sj_dbg_all("SJ: ifelse old_count == 0 \n");
	...
	sj_dbg_all("SJ: pass kbase_pm_is_suspending \n");
	...
	if (c == 1){
		...
		sj_dbg_all("SJ: ifelse First context active \n");
