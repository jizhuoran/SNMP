...
int kbase_device_init(struct kbase_device * const kbdev)
{
	...
	sj_dbg_all("SJ:kbase_device_init 1!!!\n");
	...
	sj_dbg_all("SJ:kbase_device_init 2!!!\n");
	...
	sj_dbg_all("SJ:kbase_device_init 3!!!\n");
	...
	sj_dbg_all("SJ:kbase_device_init 4!!!\n");
	...
	sj_dbg_all("SJ:kbase_device_init 5!!!\n");
