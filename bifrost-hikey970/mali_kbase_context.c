...
kbase_create_context(struct kbase_device *kbdev, bool is_compat)
{
	...
	sj_dbg_all("SJ: pass kbase_mem_pool_init 1\n");
	...
	sj_dbg_all("SJ: pass kbase_mem_pool_init 2\n");
	...
	sj_dbg_all("SJ: pass kbase_mem_evictable_init\n");
	...
	sj_dbg_all("SJ: pass kbasep_js_kctx_init\n");
	...
	sj_dbg_all("SJ: pass kbase_event_init\n");
	...
	sj_dbg_all("SJ: pass kbase_dma_fence_init\n");
	...
	sj_dbg_all("SJ: pass kbase_mmu_init\n");
	...
	do {
		...
		sj_dbg_all("SJ: pass  kbase_mem_pool_grow\n");
	...
	sj_dbg_all("SJ: pass ddooo kbase_mem_pool_grow\n");
	...
	sj_dbg_all("SJ: pass kbase_mem_alloc_page\n");
	...
	sj_dbg_all("SJ: pass kbase_region_tracker_init\n");
	...
	sj_dbg_all("SJ: pass kbase_sticky_resource_init\n");
